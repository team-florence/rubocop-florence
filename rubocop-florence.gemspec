...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency 'rubocop', '1.57.2'
  spec.add_runtime_dependency 'rubocop-capybara', '2.19.0'
  spec.add_runtime_dependency 'rubocop-factory_bot', '2.24.0'
  spec.add_runtime_dependency 'rubocop-performance', '1.19.1'
  spec.add_runtime_dependency 'rubocop-rails', '2.22.1'
  spec.add_runtime_dependency 'rubocop-rake', '0.6.0'
  spec.add_runtime_dependency 'rubocop-rspec', '2.25.0'
